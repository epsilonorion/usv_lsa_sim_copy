 ...
 * limitations under the License.math
 *
*/
...
namespace gazebo
{
  ...
  class Foil_Dynamics_Plugin : public ModelPlugin
  {
    ...
    protected: ignition::math::Vector3<double> waterCurrent;

    protected: ros::NodeHandle rosnode_;
    protected: ignition::math::Vector3<double> wind;
